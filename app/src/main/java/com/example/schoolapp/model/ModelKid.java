...
public class ModelKid {
    private String Umuaka, KidId, KidName, KidClass, KidSchool, KidImage, KidTeacherName, timestamp, uid, Gender, ParentName;

    public ModelKid(){

    }

    public ModelKid(String umuaka, String kidId, String kidName, String kidClass, String kidSchool, String kidTeacherName,
    ...
    public String getUmuaka() {
        return Umuaka;
    }

    public void setUmuaka(String umuaka) {
